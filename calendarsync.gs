// borrowed from https://developers.google.com/workspace/solutions/vacation-calendar
// click run to have this scren execute every hour, you can update the parameters of that below

// Set the ID of the team calendar to add events to. You can find the calendar's
// ID on the settings page.
//var TEAM_CALENDAR_ID = 'c_hcfsfpgviofuml215peihrjjqc@group.calendar.google.com'; // production design calendar
var TEAM_CALENDAR_ID = 'c_sebf2otar9cek3cpr6khe1btao@group.calendar.google.com'; // Design Team - Out of Office
// var TEAM_CALENDAR_ID = 'c_7c11hqcic3nig7fqrnguav55fs@group.calendar.google.com'; // test calendar
// Set the email address of the Google Group that contains everyone in the team.
// Ensure the group has less than 500 members to avoid timeouts.
var GROUP_EMAIL = 'design@chime.com';

var KEYWORDS = ['vacation', 'ooo', 'out of office', 'pto'];
